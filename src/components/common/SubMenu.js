...
export default function SubMenu(props) {
  ...
  return (
    ...
    >
      <div
        className={`absolute top-full ${props.orientation === "right" ? "left-0" : "right-0"
          } rounded-b-lg shadow-dark w-max mt-1 z-50`}
      >
              ...
              {/* {
                item.subMenu && (
                  <div className="subcategory-wrapper">
                    <SubCategory items={item.subMenu} />
                  </div>
                )
              } */}
            </Link>
