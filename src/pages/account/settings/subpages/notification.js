    ...
    <div className="w-full h-full p-10 space-y-8 max-w-3xl">
      ...
      <div className="w-full space-y-3">
        ...
        <div className="text-md text-gray-400">
          ...
          greater than or equal to this amount of BNB.
        </div>

        <div className="w-full">
          <div className="flex rounded-md shadow-sm">
            <span className="flex items-center p-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50">
              <img src={'/assets/icons/nft/bnb.svg'} className="w-5 h-5" />
              <div className="text-lg ml-3">BNB</div>
            </span>
            <input
              type="text"
              name="username"
              ...
              onChange={(e) => {
                setprice((e.target.value * 277.34).toFixed(2));
              }}
            />
